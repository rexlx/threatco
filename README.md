# threatco
a service for normalizing and enriching indicators of compromise. Use in conjuction with [rider](https://github.com/rexlx/rider) and [teller](https://github.com/rexlx/teller) to perform automated log parsing / case creation in your environment.
